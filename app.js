...
app.put('/batch', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received PUT request to update batch. Request Body: ${JSON.stringify(req.body)}`);
    ...
    */
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (update batch) has been submitted.');

    res.json({ status: true, message: 'Transaction (update batch) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error processing request: ${err}`);
...
app.post('/generateLabel', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received POST request to generate label. Request Body: ${JSON.stringify(req.body)}`);
    ...
    apiLogger.info(`Modified Request Body: ${JSON.stringify(convertedJSON)}`);

    convertedJSON.org = getOrgNameFromDepartment(convertedJSON.department);

    if (!convertedJSON.org) {
      apiLogger.error('Organization not found for this department.');
      res.json({ status: false, error: 'Organization not found for this department.' });
      return;
    }

    const gatewayOrg = (convertedJSON.org === 'Org1' ?
      await initContractFromOrg1Identity(convertedJSON.department) :
      (convertedJSON.org === 'Org2' ?
        await initContractFromOrg2Identity(convertedJSON.department) :
        await initContractFromOrg3Identity(convertedJSON.department)
      )
    );
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (generate label) has been submitted.');

    res.json({ status: true, message: 'Transaction (generate label) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error processing request: ${err}`);
...
app.post('/CaptureDispatchEvent', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received POST request to capture dispatch event. Request Body: ${JSON.stringify(req.body)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (CaptureDispatchEvent) has been submitted.');
...
app.post('/CaptureReceiveEvent', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received POST request to capture receive event. Request Body: ${JSON.stringify(req.body)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (CaptureReceiveEvent) has been submitted.');
...
app.post('/CaptureStoreEvent', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received POST request to capture store event. Request Body: ${JSON.stringify(req.body)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (CaptureStoreEvent) has been submitted.');

    res.json({ status: true, message: 'Transaction (CaptureStoreEvent) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error processing request: ${err}`);
...
app.get('/getBatchDetails/:batchId', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received GET request to get batch details. Batch ID: ${req.params.batchId}`);
    ...
    apiLogger.info(`Evaluate Transaction: QueryByBatchID, function returns details for a given batchID - Batch ID: ${req.params.batchId}`);
    
    const result = await contractOrg.evaluateTransaction('QueryByBatchID', req.params.batchId);
    apiLogger.info(`Result: ${prettyJSONString(result.toString())}`);

    // Send the batch details as a JSON response
    res.json({ status: true, batchDetails: JSON.parse(result.toString()) });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error processing get batch details request: ${err}`);
...
app.get('/getLabelDetails/:batchId', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received GET request to get label details. Batch ID: ${req.params.batchId}`);
    ...
    // Log the error
    apiLogger.error(`Error processing get label details request: ${err}`);
...
app.get('/getDispatchEventDetails/:batchId/:location/:event', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received GET request to get dispatch event details. Batch ID: ${req.params.batchId}, Location: ${req.params.location}, Event: ${req.params.event}`);
    ...
    apiLogger.info(`Evaluate Transaction: QueryDispatchEventByBatchID, function returns details for a given batchID - Batch ID: ${req.params.batchId}`);
    apiLogger.info(`Location: ${req.params.location}, Event: ${req.params.event}`);
    ...
    // Log the error
    apiLogger.error(`Error processing get dispatch event details request: ${err}`);
...
app.get('/getReceiveEventDetails/:batchId/:location/:event', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received GET request to get receive event details. Batch ID: ${req.params.batchId}, Location: ${req.params.location}, Event: ${req.params.event}`);
    ...
    apiLogger.info(`Evaluate Transaction: QueryReceiveEventByBatchID, function returns details for a given batchID - Batch ID: ${req.params.batchId}`);
    apiLogger.info(`Location: ${req.params.location}, Event: ${req.params.event}`);
    ...
    // Log the error
    apiLogger.error(`Error processing get receive event details request: ${err}`);
...
app.get('/getStoreEventDetails/:batchId', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received GET request to get store event details. Batch ID: ${req.params.batchId}`);
    ...
    apiLogger.info(`Evaluate Transaction: QueryStoreEventByBatchID, function returns details for a given batchID - Batch ID: ${req.params.batchId}`);
    ...
    // Log the error
    apiLogger.error(`Error processing get store event details request: ${err}`);
...
app.put('/updateLabel', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received PUT request to update label. Request Body: ${JSON.stringify(req.body)}`);
    ...
    apiLogger.info(`Converted JSON: ${JSON.stringify(convertedJSON)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (update label) has been submitted.');

    res.json({ status: true, message: 'Transaction (update label) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error updating label: ${err}`);
...
app.put('/UpdateReceiveEvent', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received PUT request to update receive event. Request Body: ${JSON.stringify(req.body)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (UpdateReceiveEvent) has been submitted.');

    res.json({ status: true, message: 'Transaction (UpdateReceiveEvent) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error updating receive event: ${err}`);
...
app.put('/UpdateStoreEvent', async (req, res) => {
  try {
    // Log request information
    apiLogger.info(`Received PUT request to update store event. Request Body: ${JSON.stringify(req.body)}`);
    ...
    // Log successful transaction submission
    apiLogger.info('Transaction (UpdateStoreEvent) has been submitted.');

    res.json({ status: true, message: 'Transaction (UpdateStoreEvent) has been submitted.' });
  } catch (err) {
    // Log the error
    apiLogger.error(`Error updating store event: ${err}`);
